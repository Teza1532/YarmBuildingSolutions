function Services() {
  ...
  return (
    <section id="services" className="py-20 bg-[#505052]">
      <div className="mx-auto max-w-6xl px-4">
        <h2 className="text-3xl font-bold underline-gold">What we do</h2>
        <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {data.map((s) => (
            <div key={s.title} className="rounded-2xl bg-slate-950/40 border border-white/10 p-6 hover:border-brand-gold transition">
