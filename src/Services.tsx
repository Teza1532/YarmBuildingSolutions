function Services() {
  const data = [
    ...
    { title: "Brick Rear Extension with French Doors & Feature Parapet", desc: "We delivered a stylish single-storey rear extension that blends perfectly with the home’s red-brick character. Built in matching brickwork with stone-effect heads and sills, the new addition features a crisp parapet detail and classic French doors opening to the garden. Inside, a reconfigured kitchen–dining space includes a concealed steel support wrapped and plastered to form a neat feature column and bulkhead, ready for integrated extraction and downlights. The result is a bright, functional family hub with timeless curb appeal and seamless indoor–outdoor flow.", pic: "/images/KitchenExtension.jpg"},
